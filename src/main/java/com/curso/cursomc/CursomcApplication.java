...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Categoria cat2 = new Categoria(null, "Escritório0");
		Categoria cat3 = new Categoria(null, "Escritório1");
		Categoria cat4 = new Categoria(null, "Escritório2");
		Categoria cat5 = new Categoria(null, "Escritório3");
		Categoria cat6 = new Categoria(null, "Escritório4");
		Categoria cat7 = new Categoria(null, "Escritório5");
		Categoria cat8 = new Categoria(null, "Escritório6");
		Categoria cat9 = new Categoria(null, "Escritório7");
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "359815616", TipoCliente.PESSOAFISICA );
		
		cli1.getTelefones().addAll(Arrays.asList("99998989898", "87987987987", "878787878"));	
		
		Endereco e1 = new Endereco(null, "Rua flores", "300", "Apto 300", "Jardim ", "43423423", cli1, c2);
		Endereco e2 = new Endereco(null, "Rua fsasddsad", "323", "Apto 33232", "abss ", "43423423", cli1, c1);
