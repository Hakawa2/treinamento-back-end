...
public class ClienteService {
	...
	public void delete(Integer id) {
		...
		try {
			...
			throw new DataIntegrityException("Não é possivvel excluir um cliente que possui produtos");
	...
	public Cliente fromDTO(ClienteNewDTO objDto) {
		...
		Endereco end = new Endereco(null, objDto.getLougadoro(), objDto.getNumero(), objDto.getComplemento(), objDto.getBairro(), objDto.getCep(), cli, cid);
